  ...
  template: `
    <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
      <div class="bg-light-background dark:bg-gray-700 rounded-lg p-5 text-center flex flex-col items-center">
        ...
        <p class="text-light-text dark:text-gray-300 text-xl font-bold">{{ property.stats.type }}</p>
      </div>
      <div class="bg-light-background dark:bg-gray-700 rounded-lg p-5 text-center flex flex-col items-center">
        <div class="rounded-full p-3 mb-3" [ngClass]="{'bg-primary/10 dark:bg-primary/20': true}">
        ...
        <p class="text-light-text dark:text-gray-300 text-xl font-bold">{{ property.stats.bedrooms }}</p>
      </div>
      <div class="bg-light-background dark:bg-gray-700 rounded-lg p-5 text-center flex flex-col items-center">
        <div class="rounded-full p-3 mb-3" [ngClass]="{'bg-primary/10 dark:bg-primary/20': true}">
        ...
        <p class="text-light-text dark:text-gray-300 text-xl font-bold">{{ property.stats.bathrooms }}</p>
      </div>
      <div class="bg-light-background dark:bg-gray-700 rounded-lg p-5 text-center flex flex-col items-center">
        <div class="rounded-full p-3 mb-3" [ngClass]="{'bg-primary/10 dark:bg-primary/20': true}">
        ...
        <p class="text-light-text dark:text-gray-300 text-xl font-bold">{{ property.stats.area }}</p>
      </div>
    </div>
  `
})
